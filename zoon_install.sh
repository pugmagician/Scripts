...
echo -e ${YELLOW}"Welcome to the Zoon Automated Install, Durring this Process Please Hit Enter or Input What is Asked."${NC}
echo
...
sudo git clone https://github.com/cleanblockchain/zoon.git
sudo chmod -R 755 ~/zoon 
cd zoon
sudo ./autogen.sh 
